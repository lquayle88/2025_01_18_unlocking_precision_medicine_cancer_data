## GSE21653 data access - tumour data set compendium
...
pheno_data <- sample_info %>%
  ...
  select("geo_accession", "dfs time (months):ch1", "dfs evt:ch1") %>%
  ...
  # remove cases with missing event and time to event data 
